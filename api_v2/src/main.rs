...
async fn main() {
    ...
    // SECURITY: Add standard security headers to API responses to prevent XSS, clickjacking, and MIME-type sniffing.
    // default-src 'none' is safe here since this API serves no HTML.
    let app = app
