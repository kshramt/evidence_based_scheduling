...
const SBTTB = () => {
  return (
    <ScrollBackToTopButton className="sticky top-[50%] left-[50%] -translate-x-1/2 -translate-y-1/2 btn-icon opacity-50 hover:opacity-100 min-w-[3rem] h-[3rem] text-[2rem] float-left mt-[-3rem]">
