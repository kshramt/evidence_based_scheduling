...
// ⚡ Bolt: Wrapped in React.memo to prevent unnecessary re-renders when parent list updates
// Impact: Significantly improves scrolling performance in the virtualized queue view
