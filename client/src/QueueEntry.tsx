...
// Performance optimization: Wrap QueueEntry in React.memo to prevent unnecessary re-renders
// when rendered within virtualized lists, as props (node_id, index) rarely change.
