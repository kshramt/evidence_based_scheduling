...
// Optimization: Memoize to avoid O(n) re-renders on scroll in react-virtuoso list.
// Prevents unnecessary re-renders when parent components update or unrelated store changes occur.
