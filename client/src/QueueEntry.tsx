...
// ⚡ Bolt: wrap QueueEntry in React.memo to prevent unnecessary re-renders when list data changes
...
// ⚡ Bolt: memoize inner entry wrapper to avoid re-rendering un-changed todo queue items
...
// ⚡ Bolt: memoize NonTodoQueueEntry for efficient list updates
...
// ⚡ Bolt: memoize TodoQueueEntry for efficient list updates
