...
/** ⚡ Bolt: Wrapped list item component with React.memo to prevent unnecessary O(N) re-renders during scrolling and state updates within react-virtuoso virtualized lists. */
