...
// Memoize QueueEntry to prevent unnecessary re-renders when parent components update
// but the node_id and index haven't changed. This is especially important for
// virtualized lists where re-rendering all items can cause scroll lag.
