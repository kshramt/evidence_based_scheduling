...
// Wrapped in React.memo to prevent unnecessary re-renders when the parent list re-renders.
// This is critical for performance in virtualized lists (react-virtuoso).
