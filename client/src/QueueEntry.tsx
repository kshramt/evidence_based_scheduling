...
export const QueueEntry = React.memo(
  (props: { node_id: types.TNodeId; index: number }) => {
     ...
     * Wrapped QueueEntry in React.memo to prevent unnecessary re-renders when the parent virtualized list updates.
     * This avoids re-rendering all list items when unrelated parent state changes.
     */
