...
// Optimization: Wrap QueueEntry in React.memo to prevent unnecessary re-renders.
// This is critical for the virtualized list performance, as parent re-renders
// (e.g. from filtering) would otherwise cause all visible items to re-render.
