...
// ⚡ Bolt: Memoizing QueueEntry prevents unnecessary re-renders of the entire list item when the parent list (QueueNodes or VirtualizedQueueNodes) re-renders, improving list performance.
