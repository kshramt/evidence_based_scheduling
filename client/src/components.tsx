...
// ⚡ Bolt: React.memo prevents unnecessary O(N) re-renders during list scrolling or unrelated state updates.
...
// ⚡ Bolt: React.memo prevents unnecessary O(N) re-renders when rendering large component trees.
