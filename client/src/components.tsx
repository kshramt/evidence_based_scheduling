...
// ⚡ Bolt: Wrapped MobileQueueNode in React.memo to prevent unnecessary O(N) re-renders
// during scrolling and state updates within react-virtuoso lists.
...
// ⚡ Bolt: Wrapped TreeEntry in React.memo to prevent unnecessary O(N) re-renders
// during scrolling and state updates within react-virtuoso lists.
