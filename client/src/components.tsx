...
// ⚡ Bolt: React.memo prevents unnecessary O(N) re-renders during scrolling within virtualized lists
...
// ⚡ Bolt: React.memo prevents unnecessary O(N) re-renders during scrolling and state updates within mapped arrays/virtual lists
