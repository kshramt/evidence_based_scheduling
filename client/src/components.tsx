...
// ⚡ Bolt: React.memo prevents unnecessary O(N) re-renders during scrolling and state updates within mapped arrays.
...
// ⚡ Bolt: React.memo prevents unnecessary O(N) re-renders during state updates within mapped arrays.
