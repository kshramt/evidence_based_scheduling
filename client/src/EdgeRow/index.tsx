...
// Memoize to prevent unnecessary re-renders in list context
...
// Memoize to prevent unnecessary re-renders when parent lists update
...
EdgeRowContent.displayName = "EdgeRowContent";
