...
}, b = (a) => [f.prefix, a, f.suffix].filter((e) => e && e.length > 0).join("-"), A = (a) => {
...
class z {
  ...
  async cachePut(e, t) {
    ...
    if (!r)
      return !1;
    const { cacheName: c, matchOptions: i } = this._strategy, o = await self.caches.open(c), h = this.hasCallback("cacheDidUpdate"), p = h ? await W(
...
class J {
  ...
  addToCacheList(e) {
    ...
    for (const s of e) {
      ...
      const { cacheKey: n, url: r } = G(s), c = typeof s != "string" && s.revision ? "reload" : "default";
...
let w;
const x = () => (w || (w = new Y(), w.addFetchListener(), w.addCacheListener()), w);
function E(a, e, t) {
  let s;
  if (typeof a == "string") {
...
class he extends U {
  ...
  async _handle(e, t) {
    ...
    n.push(c);
    const i = await t.waitUntil((async () => await t.waitUntil(Promise.race(n)) || // If Promise.race() resolved with null, it might be due to a network
...
class ue extends U {
  ...
  async _handle(e, t) {
    ...
    try {
      ...
      if (this._networkTimeoutSeconds) {
        const c = K(this._networkTimeoutSeconds * 1e3);
        r.push(c);
      }
...
re();
ie([{"revision":null,"url":"assets/index-0s5q-c7L.css"},{"revision":null,"url":"assets/index-DI8gcQtR.js"},{"revision":null,"url":"assets/material-icons-latin-400-normal-ebWxLnIg.woff"},{"revision":null,"url":"assets/material-icons-latin-400-normal-JAMAXUYH.woff2"},{"revision":"61bfd064535af0c276bb63b3fd579733","url":"browserconfig.xml"},{"revision":"3ee85e2b539c725c7105d703d4731efd","url":"manifest.webmanifest"},{"revision":"402b66900e731ca748771b6fc5e7a068","url":"registerSW.js"},{"revision":"41fbb88ff1f1517ab6928df333be0135","url":"static/apple-touch-icon.png"},{"revision":"c66e230ddc8819ca22e1ea0e03020acb","url":"static/favicon-16x16.png"},{"revision":"e51a14674261715d48dcc563ed7e36a7","url":"static/favicon-32x32.png"},{"revision":"218008dc2177a012d0e9f4104f164123","url":"static/favicon.ico"},{"revision":"15448a482b90f7e29a4aff1602935c34","url":"static/mstile-150x150.png"},{"revision":"54797b8db6f960236bd82c763d47dc13","url":"static/pwa-192x192.png"},{"revision":"946d614a29d8e4531dbde13a9a9d1a09","url":"static/pwa-512x512.png"},{"revision":"b2c2c8d65875e9b647b8601a146767c1","url":"static/safari-pinned-tab.svg"},{"revision":"54797b8db6f960236bd82c763d47dc13","url":"static/pwa-192x192.png"},{"revision":"946d614a29d8e4531dbde13a9a9d1a09","url":"static/pwa-512x512.png"},{"revision":"3ee85e2b539c725c7105d703d4731efd","url":"manifest.webmanifest"}]);
const O = "app";
E(({ url: a }) => a.pathname.startsWith("/api/"), new ue());
oe(
  new he({
    cacheName: O,
...
self.addEventListener("install", (a) => {
  self.skipWaiting();
  const e = new URL(".", self.location.toString()).pathname;
  a.waitUntil(
    caches.open(O).then((t) => t.addAll([`${e}index.html`, e]))
  );
});
B();
